import fr.antoineok.mcp.utils.CustomFontRenderer;
...
public class SplashProgress {
	...
	// Font renderer
	private static CustomFontRenderer raleway;
	private static CustomFontRenderer roboto;
	...
	public static void drawSplash(TextureManager tm) {
		...
		if (splash == null) splash = new ResourceLocation("textures/splash.png");
	...
	private static void drawProgress() {
		...
		if (raleway == null) raleway = new CustomFontRenderer("Raleway", 20);
		if (roboto == null) roboto = new CustomFontRenderer("Roboto", 20);
